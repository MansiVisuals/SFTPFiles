                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            VStack(alignment: .leading, spacing: 12) {
                                ...
                                InfoRow(
                                    ...
                                    description: "Use the refresh button in the main UI to update connection status"
                                )
                                InfoRow(
                                    icon: "bolt.fill",
                                    title: "Real-time Sync",
                                    description: "All connections are now updated instantly using real-time sync"
                                )
                            }
                            .padding(.horizontal, 20)
                        }
